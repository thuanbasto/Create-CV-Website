...
<c:url value="/admin/editInformation" var="url"/>

<div class="row">
	<div class="col-auto ml-3 p-4 pr-5 border border-light bg-white">
		<a href='<c:url value="/admin/userInformation/${userDTO.user_ID}"/>'>Information</a>
		<br>
		<a href='<c:url value="/admin/changePassword_Admin/${userDTO.user_ID}"/>'>Change password</a>
	</div>
				...
				<div class="form-inline mb-3">
			  	...
			  	<div class="form-inline mb-3">
					...
					<c:if test="${userDTO.state == 0}">
					  <input class="state" onchange="changeState(this)" type="checkbox" disabled="disabled">
					</c:if>
					<c:if test="${userDTO.state == 1}">
					  <input class="state" onchange="changeState(this)" type="checkbox" checked="checked" disabled="disabled">
					</c:if>
...
<script src="<c:url value="/static/js/userInformation.js"/>"></script>
