...
<c:url value="/admin/changePassword_Admin/${user_ID}" var="url"/>

<div class="row">
	<div class="col-auto ml-3 p-4 pr-5 border border-light bg-white">
		<a href='<c:url value="/admin/userInformation/${user_ID}"/>'>Information</a>
		<br>
		<a href='<c:url value="/admin/changePassword_Admin/${user_ID}"/>'>Change password</a>
	</div>
